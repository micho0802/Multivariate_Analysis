...
#Bonferroni 95% confidence intervals. There are 4(3)(2)/2=12 possible pairwise comparisons.
#Here are the intervals for comparing nursing homes interms of the variable X3.

qt(0.05/(4*3*(3-1)),516-3,lower.tail=FALSE)

xbar1[3]-xbar2[3]+c(-1,1)*qt(0.05/(4*3*(3-1)),n-g,lower.tail=FALSE)*sqrt((1/n1+1/n2)*W[3,3]/(n-g))
xbar1[3]-xbar3[3]+c(-1,1)*qt(0.05/(4*3*(3-1)),n-g,lower.tail=FALSE)*sqrt((1/n1+1/n3)*W[3,3]/(n-g))
xbar2[3]-xbar3[3]+c(-1,1)*qt(0.05/(4*3*(3-1)),n-g,lower.tail=FALSE)*sqrt((1/n2+1/n3)*W[3,3]/(n-g))
